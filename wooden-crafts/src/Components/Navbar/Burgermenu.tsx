...
import logo3 from "./logo/logo2.png";
      ...
      <Drawer isOpen={isOpen} placement="left" onClose={onClose}>
        ...
        <DrawerContent>
          ...
          <Flex justifyContent={"space-around"} marginTop={"10px"}>
            <Link to="/">
              <img id="Burgerlogo" src={logo3}></img>
            </Link>
            <Link to="/login">
              <BiUserCircle
                className="icon"
            ...
            <Accordion allowToggle>
              ...
              <AccordionItem>
                ...
                <AccordionPanel pb={4}>
                  ...
                  <ul className="mega-links">
                    <li>
                      <Link to="../HTML/product.html">Fabric Sofas</Link>
                    </li>
                    <li>
                      <Link to="/product">Sofa cum Bed</Link>
                    </li>
              ...
              <AccordionItem>
                ...
                <AccordionPanel pb={4}>
                  <section>
                    ...
                    <ul className="mega-links">
                      <li>
                        <Link to="../HTML/product.html">King Size Beds</Link>
                      </li>
                      <li>
              ...
              <AccordionItem>
                ...
                <AccordionPanel pb={4}>
                  <section>
                    ...
                    <ul className="mega-links">
                      <li>
                        <Link to="../HTML/product.html">Dining Table Sets</Link>
                      </li>
                      <li>
                  ...
                  <section>
                    ...
                    <ul className="mega-links">
                      <li>
                        <Link to="/product">L-Shaped Modular Kitchen</Link>
                      </li>
                      <li>
                        <Link to="/product">U-Shaped Modular Kitchen</Link>
                      </li>
                      <li>
                        <Link to="/product">
